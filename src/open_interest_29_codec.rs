...
pub use encoder::OpenInterest_29Encoder;
pub use decoder::OpenInterest_29Decoder;

pub const SBE_BLOCK_LENGTH: u16 = 32;
pub const SBE_TEMPLATE_ID: u16 = 29;
...
pub mod encoder {
    ...
    pub struct OpenInterest_29Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OpenInterest_29Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OpenInterest_29Encoder<'a> {
        #[inline]
    ...
    impl<'a> OpenInterest_29Encoder<'a> {
...
pub mod decoder {
    ...
    pub struct OpenInterest_29Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for OpenInterest_29Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for OpenInterest_29Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OpenInterest_29Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> OpenInterest_29Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::OPEN_INTEREST
        }
