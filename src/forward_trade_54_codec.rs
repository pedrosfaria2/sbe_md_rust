...
pub use encoder::ForwardTrade_54Encoder;
pub use decoder::ForwardTrade_54Decoder;
...
pub mod encoder {
    ...
    pub struct ForwardTrade_54Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ForwardTrade_54Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ForwardTrade_54Encoder<'a> {
        #[inline]
    ...
    impl<'a> ForwardTrade_54Encoder<'a> {
...
pub mod decoder {
    ...
    pub struct ForwardTrade_54Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ForwardTrade_54Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ForwardTrade_54Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ForwardTrade_54Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ForwardTrade_54Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
