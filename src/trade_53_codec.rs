...
pub use encoder::Trade_53Encoder;
pub use decoder::Trade_53Decoder;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for Trade_53Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for Trade_53Encoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a> ActingVersion for Trade_53Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for Trade_53Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for Trade_53Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
