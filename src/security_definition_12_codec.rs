...
pub use encoder::SecurityDefinition_12Encoder;
pub use decoder::SecurityDefinition_12Decoder;
...
pub mod encoder {
    ...
    pub struct SecurityDefinition_12Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SecurityDefinition_12Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SecurityDefinition_12Encoder<'a> {
        #[inline]
    ...
    impl<'a> SecurityDefinition_12Encoder<'a> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn min_price_increment_encoder(self) -> fixed_8_codec::Fixed8Encoder<Self> {
...
pub mod decoder {
    ...
    pub struct SecurityDefinition_12Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for SecurityDefinition_12Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SecurityDefinition_12Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SecurityDefinition_12Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SecurityDefinition_12Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn min_price_increment_decoder(self) -> fixed_8_codec::Fixed8Decoder<Self> {
            let offset = self.offset + 44;
    ...
    impl<'a, P> NoUnderlyingsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='noUnderlyings', referencedName='null', description='Underlying instruments.', packageName='null', id=711, version=0, deprecated=0, encodedLength=28, offset=230, componentTokenCount=21, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
