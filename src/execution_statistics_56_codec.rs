...
pub use encoder::ExecutionStatistics_56Encoder;
pub use decoder::ExecutionStatistics_56Decoder;
...
pub mod encoder {
    ...
    pub struct ExecutionStatistics_56Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionStatistics_56Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionStatistics_56Encoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionStatistics_56Encoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn trade_volume(&mut self, value: i64) {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn vwap_px_encoder(self) -> price_optional_codec::PriceOptionalEncoder<Self> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn net_chg_prev_day_encoder(self) -> price_offset_8_optional_codec::PriceOffset8OptionalEncoder<Self> {
            let offset = self.offset + 28;
            price_offset_8_optional_codec::PriceOffset8OptionalEncoder::default().wrap(self, offset)
        }

        /// primitive field 'numberOfTrades'
        /// - min value: 0
        ...
        /// - version: 0
        #[inline]
        pub fn number_of_trades(&mut self, value: u32) {
...
pub mod decoder {
    ...
    pub struct ExecutionStatistics_56Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionStatistics_56Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionStatistics_56Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionStatistics_56Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionStatistics_56Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::EXECUTION_STATISTICS
        }
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn trade_volume(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 12)
        }

        /// COMPOSITE DECODER
        #[inline]
        pub fn vwap_px_decoder(self) -> price_optional_codec::PriceOptionalDecoder<Self> {
            let offset = self.offset + 20;
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn net_chg_prev_day_decoder(self) -> price_offset_8_optional_codec::PriceOffset8OptionalDecoder<Self> {
            let offset = self.offset + 28;
            price_offset_8_optional_codec::PriceOffset8OptionalDecoder::default().wrap(self, offset)
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn number_of_trades(&self) -> u32 {
        ...
        pub fn rpt_seq(&self) -> Option<u32> {
            let value = self.get_buf().get_u32_at(self.offset + 48);
            if value == 0x0_u32 {
                None
            } else {
                Some(value)
