...
pub use encoder::SecurityStatus_3Encoder;
pub use decoder::SecurityStatus_3Decoder;
...
pub mod encoder {
    ...
    pub struct SecurityStatus_3Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SecurityStatus_3Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SecurityStatus_3Encoder<'a> {
        #[inline]
    ...
    impl<'a> SecurityStatus_3Encoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn security_trading_status(&mut self, value: security_trading_status::SecurityTradingStatus) {
...
pub mod decoder {
    ...
    pub struct SecurityStatus_3Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for SecurityStatus_3Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SecurityStatus_3Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SecurityStatus_3Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SecurityStatus_3Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn security_trading_status(&self) -> security_trading_status::SecurityTradingStatus {
