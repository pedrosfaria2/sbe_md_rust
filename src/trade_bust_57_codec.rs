...
pub use encoder::TradeBust_57Encoder;
pub use decoder::TradeBust_57Decoder;
...
pub mod encoder {
    ...
    pub struct TradeBust_57Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for TradeBust_57Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TradeBust_57Encoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct TradeBust_57Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for TradeBust_57Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TradeBust_57Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TradeBust_57Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> TradeBust_57Decoder<'a> {
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::TRADE_BUST
        }
        ...
        pub fn trade_date(&self) -> u16 {
            self.get_buf().get_u16_at(self.offset + 32)
        }
