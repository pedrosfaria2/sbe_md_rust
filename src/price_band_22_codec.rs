...
pub use encoder::PriceBand_22Encoder;
pub use decoder::PriceBand_22Decoder;
...
pub mod encoder {
    ...
    pub struct PriceBand_22Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for PriceBand_22Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for PriceBand_22Encoder<'a> {
        #[inline]
    ...
    impl<'a> PriceBand_22Encoder<'a> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn trading_reference_price_encoder(self) -> fixed_8_codec::Fixed8Encoder<Self> {
...
pub mod decoder {
    ...
    pub struct PriceBand_22Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for PriceBand_22Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for PriceBand_22Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for PriceBand_22Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> PriceBand_22Decoder<'a> {
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn trading_reference_price_decoder(self) -> fixed_8_codec::Fixed8Decoder<Self> {
            let offset = self.offset + 28;
