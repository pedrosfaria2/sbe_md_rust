...
pub use encoder::QuantityBand_21Encoder;
pub use decoder::QuantityBand_21Decoder;
...
pub mod encoder {
    ...
    pub struct QuantityBand_21Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for QuantityBand_21Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for QuantityBand_21Encoder<'a> {
        #[inline]
    ...
    impl<'a> QuantityBand_21Encoder<'a> {
        ...
        /// primitive field 'avgDailyTradedQty'
        ...
        /// - version: 0
        #[inline]
        pub fn avg_daily_traded_qty(&mut self, value: i64) {
        ...
        /// - version: 0
        #[inline]
        pub fn max_trade_vol(&mut self, value: i64) {
...
pub mod decoder {
    ...
    pub struct QuantityBand_21Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for QuantityBand_21Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for QuantityBand_21Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for QuantityBand_21Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> QuantityBand_21Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::QUANTITY_BAND
        }

        /// primitive field - 'OPTIONAL' { null_value: '-9223372036854775808' }
        #[inline]
        pub fn avg_daily_traded_qty(&self) -> Option<i64> {
