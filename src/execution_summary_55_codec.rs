...
pub use encoder::ExecutionSummary_55Encoder;
pub use decoder::ExecutionSummary_55Decoder;
...
pub mod encoder {
    ...
    pub struct ExecutionSummary_55Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionSummary_55Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionSummary_55Encoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionSummary_55Encoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn aggressor_side(&mut self, value: aggressor_side::AggressorSide) {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn last_px_encoder(self) -> price_codec::PriceEncoder<Self> {
        ...
        /// - version: 0
        #[inline]
        pub fn fill_qty(&mut self, value: i64) {
            let offset = self.offset + 20;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'tradedHiddenQty'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn traded_hidden_qty(&mut self, value: i64) {
            let offset = self.offset + 28;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'cxlQty'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn cxl_qty(&mut self, value: i64) {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn aggressor_time_encoder(self) -> utc_timestamp_nanos_codec::UTCTimestampNanosEncoder<Self> {
...
pub mod decoder {
    ...
    pub struct ExecutionSummary_55Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionSummary_55Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionSummary_55Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionSummary_55Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionSummary_55Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::EXECUTION_SUMMARY
        }

        /// REQUIRED enum
        #[inline]
        pub fn aggressor_side(&self) -> aggressor_side::AggressorSide {
            self.get_buf().get_u8_at(self.offset + 10).into()
        }

        /// COMPOSITE DECODER
        #[inline]
        pub fn last_px_decoder(self) -> price_codec::PriceDecoder<Self> {
            let offset = self.offset + 12;
        ...
        #[inline]
        pub fn traded_hidden_qty(&self) -> Option<i64> {
        ...
        /// primitive field - 'OPTIONAL' { null_value: '-9223372036854775808' }
        #[inline]
        pub fn cxl_qty(&self) -> Option<i64> {
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn aggressor_time_decoder(self) -> utc_timestamp_nanos_codec::UTCTimestampNanosDecoder<Self> {
            let offset = self.offset + 44;
