...
pub use encoder::OpeningPrice_15Encoder;
pub use decoder::OpeningPrice_15Decoder;
...
pub mod encoder {
    ...
    pub struct OpeningPrice_15Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OpeningPrice_15Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OpeningPrice_15Encoder<'a> {
        #[inline]
    ...
    impl<'a> OpeningPrice_15Encoder<'a> {
...
pub mod decoder {
    ...
    pub struct OpeningPrice_15Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for OpeningPrice_15Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for OpeningPrice_15Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OpeningPrice_15Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> OpeningPrice_15Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::OPENING_PRICE
        }
