...
pub use encoder::EmptyBook_9Encoder;
pub use decoder::EmptyBook_9Decoder;
...
pub mod encoder {
    ...
    pub struct EmptyBook_9Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for EmptyBook_9Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for EmptyBook_9Encoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct EmptyBook_9Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for EmptyBook_9Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for EmptyBook_9Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for EmptyBook_9Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
