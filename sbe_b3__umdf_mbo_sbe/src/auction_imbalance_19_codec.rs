...
pub use encoder::AuctionImbalance_19Encoder;
pub use decoder::AuctionImbalance_19Decoder;
...
pub mod encoder {
    ...
    pub struct AuctionImbalance_19Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AuctionImbalance_19Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AuctionImbalance_19Encoder<'a> {
        #[inline]
    ...
    impl<'a> AuctionImbalance_19Encoder<'a> {
        ...
        #[inline]
        pub fn imbalance_condition(&mut self, value: imbalance_condition::ImbalanceCondition) {
...
pub mod decoder {
    ...
    pub struct AuctionImbalance_19Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for AuctionImbalance_19Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AuctionImbalance_19Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AuctionImbalance_19Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AuctionImbalance_19Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::IMBALANCE
        }

        /// BIT SET DECODER
        #[inline]
        pub fn imbalance_condition(&self) -> imbalance_condition::ImbalanceCondition {
            imbalance_condition::ImbalanceCondition::new(self.get_buf().get_u16_at(self.offset + 10))
        }

        /// primitive field - 'OPTIONAL' { null_value: '-9223372036854775808' }
        #[inline]
        pub fn mde_ntry_size(&self) -> Option<i64> {
