...
pub use encoder::LastTradePrice_27Encoder;
pub use decoder::LastTradePrice_27Decoder;

pub const SBE_BLOCK_LENGTH: u16 = 68;
...
pub mod encoder {
    ...
    pub struct LastTradePrice_27Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for LastTradePrice_27Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for LastTradePrice_27Encoder<'a> {
        #[inline]
    ...
    impl<'a> LastTradePrice_27Encoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn trade_id(&mut self, value: u32) {
            let offset = self.offset + 28;
            self.get_buf_mut().put_u32_at(offset, value);
        }

        /// primitive field 'mDEntryBuyer'
        /// - min value: 0
        /// - max value: 4294967294
        /// - null value: 0
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn mde_ntry_buyer(&mut self, value: u32) {
            let offset = self.offset + 32;
            self.get_buf_mut().put_u32_at(offset, value);
        }

        /// primitive field 'mDEntrySeller'
        /// - min value: 0
        /// - max value: 4294967294
        /// - null value: 0
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn mde_ntry_seller(&mut self, value: u32) {
        ...
        /// - version: 0
        #[inline]
        pub fn seller_days(&mut self, value: u16) {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn md_entry_interest_rate_encoder(self) -> percentage_codec::PercentageEncoder<Self> {
            let offset = self.offset + 56;
            percentage_codec::PercentageEncoder::default().wrap(self, offset)
        }

        /// REQUIRED enum
        #[inline]
        pub fn trd_sub_type(&mut self, value: trd_sub_type::TrdSubType) {
...
pub mod decoder {
    ...
    pub struct LastTradePrice_27Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for LastTradePrice_27Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for LastTradePrice_27Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for LastTradePrice_27Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> LastTradePrice_27Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn trade_condition(&self) -> trade_condition::TradeCondition {
            trade_condition::TradeCondition::new(self.get_buf().get_u16_at(self.offset + 10))
        }
        ...
        /// primitive field - 'OPTIONAL' { null_value: '0' }
        #[inline]
        pub fn mde_ntry_seller(&self) -> Option<u32> {
            let value = self.get_buf().get_u32_at(self.offset + 36);
            if value == 0x0_u32 {
                None
            } else {
                Some(value)
        ...
        pub fn trade_date(&self) -> u16 {
            self.get_buf().get_u16_at(self.offset + 40)
        }
        ...
        pub fn rpt_seq(&self) -> Option<u32> {
            let value = self.get_buf().get_u32_at(self.offset + 50);
            if value == 0x0_u32 {
                None
            } else {
                Some(value)
        ...
        /// primitive field - 'OPTIONAL' { null_value: '0' }
        #[inline]
        pub fn seller_days(&self) -> Option<u16> {
            let value = self.get_buf().get_u16_at(self.offset + 54);
            if value == 0x0_u16 {
                None
            } else {
                Some(value)
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn md_entry_interest_rate_decoder(self) -> percentage_codec::PercentageDecoder<Self> {
            let offset = self.offset + 56;
            percentage_codec::PercentageDecoder::default().wrap(self, offset)
        }

        /// REQUIRED enum
        #[inline]
        pub fn trd_sub_type(&self) -> trd_sub_type::TrdSubType {
            if self.acting_version() < 7 {
                return trd_sub_type::TrdSubType::default();
            }
