...
pub use encoder::MassDeleteOrders_MBO_52Encoder;
pub use decoder::MassDeleteOrders_MBO_52Decoder;
...
pub mod encoder {
    ...
    pub struct MassDeleteOrders_MBO_52Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for MassDeleteOrders_MBO_52Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for MassDeleteOrders_MBO_52Encoder<'a> {
        #[inline]
    ...
    impl<'a> MassDeleteOrders_MBO_52Encoder<'a> {
...
pub mod decoder {
    ...
    pub struct MassDeleteOrders_MBO_52Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for MassDeleteOrders_MBO_52Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MassDeleteOrders_MBO_52Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for MassDeleteOrders_MBO_52Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> MassDeleteOrders_MBO_52Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn rpt_seq(&self) -> Option<u32> {
            let value = self.get_buf().get_u32_at(self.offset + 24);
            if value == 0x0_u32 {
                None
            } else {
                Some(value)
