...
pub use encoder::DeleteOrder_MBO_51Encoder;
pub use decoder::DeleteOrder_MBO_51Decoder;
...
pub mod encoder {
    ...
    pub struct DeleteOrder_MBO_51Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for DeleteOrder_MBO_51Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for DeleteOrder_MBO_51Encoder<'a> {
        #[inline]
    ...
    impl<'a> DeleteOrder_MBO_51Encoder<'a> {
...
pub mod decoder {
    ...
    pub struct DeleteOrder_MBO_51Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for DeleteOrder_MBO_51Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for DeleteOrder_MBO_51Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for DeleteOrder_MBO_51Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> DeleteOrder_MBO_51Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn rpt_seq(&self) -> Option<u32> {
            let value = self.get_buf().get_u32_at(self.offset + 40);
            if value == 0x0_u32 {
                None
            } else {
                Some(value)
