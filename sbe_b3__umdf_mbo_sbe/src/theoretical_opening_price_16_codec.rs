...
pub use encoder::TheoreticalOpeningPrice_16Encoder;
pub use decoder::TheoreticalOpeningPrice_16Decoder;
...
pub mod encoder {
    ...
    pub struct TheoreticalOpeningPrice_16Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for TheoreticalOpeningPrice_16Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TheoreticalOpeningPrice_16Encoder<'a> {
        #[inline]
    ...
    impl<'a> TheoreticalOpeningPrice_16Encoder<'a> {
        ...
        // skipping CONSTANT enum 'openCloseSettlFlag'
...
pub mod decoder {
    ...
    pub struct TheoreticalOpeningPrice_16Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for TheoreticalOpeningPrice_16Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TheoreticalOpeningPrice_16Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TheoreticalOpeningPrice_16Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> TheoreticalOpeningPrice_16Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn open_close_settl_flag(&self) -> open_close_settl_flag::OpenCloseSettlFlag {
            open_close_settl_flag::OpenCloseSettlFlag::THEORETICAL_PRICE
        }
