...
pub use encoder::SettlementPrice_28Encoder;
pub use decoder::SettlementPrice_28Decoder;

pub const SBE_BLOCK_LENGTH: u16 = 36;
pub const SBE_TEMPLATE_ID: u16 = 28;
...
pub mod encoder {
    ...
    pub struct SettlementPrice_28Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SettlementPrice_28Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SettlementPrice_28Encoder<'a> {
        #[inline]
    ...
    impl<'a> SettlementPrice_28Encoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn settl_price_type(&mut self, value: settl_price_type::SettlPriceType) {
...
pub mod decoder {
    ...
    pub struct SettlementPrice_28Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for SettlementPrice_28Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SettlementPrice_28Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SettlementPrice_28Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SettlementPrice_28Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn mde_ntry_type(&self) -> md_entry_type::MDEntryType {
            md_entry_type::MDEntryType::SETTLEMENT_PRICE
        }
        ...
        /// REQUIRED enum
        #[inline]
        pub fn settl_price_type(&self) -> settl_price_type::SettlPriceType {
        ...
        pub fn rpt_seq(&self) -> Option<u32> {
            let value = self.get_buf().get_u32_at(self.offset + 31);
            if value == 0x0_u32 {
                None
            } else {
                Some(value)
